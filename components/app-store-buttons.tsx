  ...
  return (
    <div className="flex flex-wrap items-center gap-4">
      ...
      <a
        ...
        className="inline-flex items-center gap-3 rounded-xl border border-white/20 bg-white/5 px-5 py-3 transition-all duration-200 hover:border-white/40 hover:bg-white/10"
      >
