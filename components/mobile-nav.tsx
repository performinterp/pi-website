  ...
  return (
    <>
      ...
      <div
        ...
        className={`fixed inset-y-0 right-0 z-50 flex w-full max-w-sm flex-col bg-pi-navy/95 backdrop-blur-md shadow-2xl transition-transform duration-300 ease-out ${
