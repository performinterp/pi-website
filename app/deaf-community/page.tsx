...
const appFeatures = [
  ...
  {
    icon: "check",
    title: "Check BSL status",
    description:
      "Enter any event name to check if BSL interpreting is confirmed. No more calling venues.",
  },
  {
    icon: "hand-metal",
    title: "Request access",
    description:
      "Want BSL at an event that doesn't have it? Submit a request and we'll contact the organiser.",
  },
  {
    icon: "shield",
  ...
  return (
    <>
      <PageHero
        ...
        subtitle="Find BSL-interpreted events. Get support at the venue. Never miss out."
        backgroundImage="/images/football-stadium.jpg"
      />
      ...
      <section className="section-padding section-gap">
        <div className="mx-auto max-w-4xl text-center">
          <AnimateIn>
            ...
            <h2 className="mt-3 font-display text-3xl text-white md:text-4xl">
              What BSL interpreting at live events looks like
            </h2>
          </AnimateIn>
        </div>
        ...
        <div className="mx-auto max-w-3xl text-center">
          <AnimateIn>
            ...
            <p className="mx-auto mt-5 max-w-xl text-base leading-relaxed text-white/60">
              Share your experience through the app — written or BSL video. Your feedback goes straight to us and helps hold venues to account.
            </p>
          </AnimateIn>
          <AnimateIn delay={100}>
