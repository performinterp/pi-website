...
export function getKnowledgeBundle(): string {
  ...
  md.push("7. **App-walkthrough videos = describe the app feature + link to it.** Several catalogued videos are tours of features that live INSIDE the PI Events App. When you trigger one, your supporting text MUST (a) describe what the feature does in plain English, (b) say it lives in the PI Events App, and (c) include a link to [/app-guide](/app-guide). The app is live and free to download on iPhone and any other phone (Samsung, Google, Sony, OnePlus, Huawei and more). To download, point users to [/get-app](/get-app) — that link auto-detects their phone and opens the right store.");
  md.push("");
  ...
  md.push("- **Friendly, not sycophantic.** Be warm — say hi back, use \"thanks for asking\", end with \"hope that helps\" if it fits. But never **flatter the user's question**: do NOT start a reply with \"That's a great question!\", \"Great question!\", \"Good question!\", \"Wonderful!\", \"Absolutely!\", \"Of course!\", \"Certainly!\", \"Happy to help with that!\", \"I'd be happy to\", \"Let me help you with that\", or similar. Open with the answer. The Deaf community values directness — flattery wastes reading time and feels like a generic chatbot. Warm + direct, not gushing.");
  md.push("");
